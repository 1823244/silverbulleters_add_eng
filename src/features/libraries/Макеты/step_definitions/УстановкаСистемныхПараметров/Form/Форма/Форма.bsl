...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗадаюСистемныеПараметрыСчитыванияМакетаНачСтрНачКолКолСтрКолКол(Парам01,Парам02,Парам03,Парам04)",
		"ЯЗадаюСистемныеПараметрыСчитыванияМакетаНачСтрНачКолКолСтрКолКол",
		"Когда Я задаю системные параметры считывания макета НачСтр 1 НачКол 1 КолСтр 100 КолКол 20",
		"Задаются системные параметры считывания макета", "UI.Табличный документ.Область чтения");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗадаюПараметрыСчитыванияМакетаНачСтрНачКолКолСтрКолКол(Парам01,Парам02,Парам03,Парам04)",
		"ЯЗадаюПараметрыСчитыванияМакетаНачСтрНачКолКолСтрКолКол",
		"Когда Я задаю параметры считывания макета НачСтр 1 НачКол 1 КолСтр 100 КолКол 20",
		"Задаются параметры считывания макета", "UI.Табличный документ.Область чтения");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯЗадаюПараметрыЧтенияОбластиМакета(Парам01)","ЯЗадаюПараметрыЧтенияОбластиМакета",
		"Когда Я задаю параметры чтения области макета ""R1C1:R100C20""",
		"Указывает область чтения макета, когда он считывается по одной ячейке из данных TestClient",
		"UI.Табличный документ.Область чтения");
